...
const model_2 = require("./triggers/model");
const fetch_model_1 = require("./triggers/fetch.model");
const fetch_event_1 = require("./triggers/fetch.event");
...
exports.default = {
    ...
    triggers: {
        [model_2.default.key]: model_2.default,
        [fetch_model_1.default.key]: fetch_model_1.default,
        [fetch_event_1.default.key]: fetch_event_1.default,
    },
    creates: {
